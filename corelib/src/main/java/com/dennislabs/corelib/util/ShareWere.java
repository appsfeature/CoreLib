...
public class ShareWere {
    ...
    public static void rateUs(Activity activity) {
        Intent browserIntent1 = new Intent(Intent.ACTION_VIEW, Uri.parse(CoreLib.PLAYSTORE_URL+activity.getPackageName()));
        activity.startActivity(browserIntent1);
    }
    ...
    public static void shareApp(Activity activity) {
        ...
        intent.putExtra(Intent.EXTRA_TEXT, "Check out this app! "+CoreLib.PLAYSTORE_URL+activity.getPackageName());
